...
/* It's important avoid vulnerabilities due to numeric overflow bugs
...
contract FlightSuretyApp {
    ...
    address[] private mulitcalls = new address[](0);
    ...
    function isOperational() public view returns (bool) {
        return flightSuretyData.isOperational(); true; // Modify to call data contract's status
    }
   ...
   event registered(uint256 debug);
        ...
        returns (bool success)
    {
        ...
        if (airlinesCount >= 4) {
            ...
            for (uint256 i = 0; i < mulitcalls.length; i++) {
    ...
    function registerFlight() external pure {
        ...
        address public = address ({flight, passengers , amountPaid})
